...
function main() {
    ...
    pulse_uniforms.u_resolution.value.y = window.innerHeight / 20;
    ...
    // var mesh = new THREE.Mesh(new THREE.PlaneGeometry(window.innerWidth, window.innerHeight), pulse_material);
    // scene.add(mesh);
